...
interface InventoryContextType {
  ...
  addEntrada: (data: { obraId: string; insumoId: string; notaFiscal: string; quantity: number; unitValue: number; totalValue: number; date: string; validade?: string; lote?: string; ocItemId?: string; fvmId?: string }) => Promise<void>;
